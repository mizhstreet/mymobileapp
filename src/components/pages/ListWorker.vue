<template id="list-user">
    <f7-page>
      ...
      <f7-list media-list contacts>
        ...
        <f7-popup id="addWorker-popup" no-navbar style="background-color:#efeff4">
              <f7-block-title>Tao cong nhan moi</f7-block-title>
              <f7-list form id="my-form">
                ...
                <f7-list-item>
                    ...
                    <f7-list-item radio inline name="gender" value="0" title="女性" checked></f7-list-item>
                    <f7-list-item radio inline name="gender" value="1" title="男性"></f7-list-item>
                </f7-list-item>
                <f7-list-item>
                 <div>
            ...
            if(result){
              ...
              self.$http.post(cf.serverURL + 'create-user',
                ...
                function(res){
                  ...
                  myApp.closeModal('#addWorker-popup');
